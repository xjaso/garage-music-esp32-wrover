...
void avrc_metadata_srv_open(void)
{
    ...
    avrc_metadata_srv_md_free(ESP_AVRC_MD_ATTR_GENRE | ESP_AVRC_MD_ATTR_PLAYING_TIME);
...
void avrc_metadata_srv_md_save(avrc_metadata_srv_param_t *param)
{
    ...
    case ESP_AVRC_MD_ATTR_TITLE: {
        avrc_metadata_srv_copy_metadata(&s_avrc_metadata_srv_cb.attr_title, rc); garage_ui_set_title((const char *)s_avrc_metadata_srv_cb.attr_title.attr_text); break;
    }
    case ESP_AVRC_MD_ATTR_ARTIST: {
        avrc_metadata_srv_copy_metadata(&s_avrc_metadata_srv_cb.attr_artist, rc); garage_ui_set_artist((const char *)s_avrc_metadata_srv_cb.attr_artist.attr_text); break;
    }
    case ESP_AVRC_MD_ATTR_ALBUM: {
        avrc_metadata_srv_copy_metadata(&s_avrc_metadata_srv_cb.attr_album, rc); garage_ui_set_album((const char *)s_avrc_metadata_srv_cb.attr_album.attr_text); break;
    }
    case ESP_AVRC_MD_ATTR_GENRE | ESP_AVRC_MD_ATTR_PLAYING_TIME: {
